        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" id="nama_item">Nama : </li>
                        <li class="list-group-item" id="no_item">No Konfirmasi : </li>
                        <li class="list-group-item" id="grup_item">Grup : </li>
                        <li class="list-group-item" id="program_item">Program : </li>
                        <li class="list-group-item" id="status_item">Status :  </li>
                        <li class="list-group-item" id="presence_item">Presence Time :  </li>
                    </ul>
                    </div>
                </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function show_product(){
                $.ajax({
                    url   : '<?php echo site_url("realtime/get_peserta");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                    success : function(data){
            ...
            function show_latest(){
                $.ajax({
                    url   : '<?php echo site_url("realtime/get_latest_peserta");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                    success : function(data){
                        ...
                        $.each(data, function(index, element) {
                            ...
                            $('#nama_item').html("Nama : " + element.nama);
                            $('#no_item').html("No Konfirmasi : " + element.no_konfirmasi);
                            $('#program_item').html("Program : " + element.program);
